...
function emailHtml(p: { title: string; summary?: string; cover?: string; url: string }) {
  ...
  <div style="font-family:Inter,Arial,sans-serif;background:#0b0b0d;color:#f5f3ee;padding:32px;border-radius:16px;max-width:560px;margin:auto">
    <div style="font-size:11px;letter-spacing:.2em;text-transform:uppercase;color:#c9a84c">New episode • Zamani Vibes</div>
    ...
    <p style="font-size:11px;color:#777;margin-top:32px">You're receiving this because you subscribed to Zamani Vibes.</p>
  </div>`;
}
